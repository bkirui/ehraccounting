 ...
 */
package org.openmrs.module.ehraccounting.api;
...
import org.openmrs.module.ehraccounting.EhraccountingConfig;
 ...
 * <code>
 * Context.getService(EhraccountingService.class).someMethod();
 * </code>
 *
 * @see org.openmrs.api.context.Context
 */
@Transactional
public interface EhraccountingService extends OpenmrsService {


	/**
	 * 	Account
	 */
	@Authorized({ EhraccountingConstants.PRIV_ADD_EDIT_ACCOUNT })
	public Account saveAccount(Account acc, Integer periodId);

	@Authorized({ EhraccountingConstants.PRIV_DELETE_ACCOUNT })
	public void deleteAccount(Account acc);

	@Transactional(readOnly = true)
	@Authorized({ EhraccountingConstants.PRIV_VIEW_ACCOUNT })
