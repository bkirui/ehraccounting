 ...
 */
package org.openmrs.module.ehraccounting.api.impl;
...
import org.openmrs.module.ehraccounting.api.model.AccountTransaction;
...
import org.openmrs.module.ehraccounting.api.model.TransactionStatus;
import org.openmrs.module.ehraccounting.api.model.TransactionType;
import org.openmrs.module.ehraccounting.api.utils.EhraccountingConstants;
...
public class EhraccountingServiceImpl extends BaseOpenmrsService implements EhraccountingService {
	...
	private EhraccountingDAO dao;

	/**
	 * @param dao the dao to set
	 */
	public void setDao(EhraccountingDAO dao) {
		this.dao = dao;
	}
	 ...
	 * @return the dao
	 */
	public EhraccountingDAO getDao() {
		return dao;
	}
	...
	public void initModule() {
		log.debug("****************************************");
		log.debug("INIT EHRACCOUNTING MODULE");
		log.debug("****************************************");
	...
	*/
	...
	public void retireBudgetItem(Integer id) throws Exception {
		...
		if (!Context.getService(EhraccountingService.class).isEditableBudget(item) ) {
...
//				addAccountTransaction(payment);
	...
	public void aggregateIncomeReceipt(Date date) throws Exception {
		...
		if (accounts != null && accounts.size() > 0) {
			...
			IncomeReceipt receipt = dao.getIncomeReceiptByReceiptNo(EhraccountingConstants.INCOME_RECEIPT_NO_PREFIX
			...
			if (receipt == null) {
				...
				receipt.setReceiptNo(EhraccountingConstants.INCOME_RECEIPT_NO_PREFIX + DateUtils.getStringFromDate(date));
